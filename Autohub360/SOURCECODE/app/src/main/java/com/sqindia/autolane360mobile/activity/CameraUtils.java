...
public class CameraUtils {
    ...
    public static File getOutputMediaFile(int type) {
        ...
        File mediaStorageDir = new File(
                ...
                UploadCarPageThreeFragment.GALLERY_DIRECTORY_NAME);

        // Create the storage directory if it does not exist
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.e(UploadCarPageThreeFragment.GALLERY_DIRECTORY_NAME, "Oops! Failed create "
                        + UploadCarPageThreeFragment.GALLERY_DIRECTORY_NAME + " directory");
                return null;
            }
        }
        ...
        File mediaFile;
        if (type == UploadCarPageThreeFragment.MEDIA_TYPE_VIDEO) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "VID_" + timeStamp + "." + UploadCarPageThreeFragment.VIDEO_EXTENSION);
        } else {
            return null;
        }

...
public class OrderListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<OrderSingleItemListPojo> singleItemListPojos;
    ...
    public OrderListAdapter(OrderPageActivity orderPageActivity, List<OrderSingleItemListPojo> singleItemListPojos) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final OrderSingleItemListPojo current=singleItemListPojos.get(position);

...
public class HttpUtils {
    ...
    public static String makeRequestUrlToken(String url, String token) {
        Log.e(TAG, "URL-->" + url);
    ...
    public static String makeRequestPut(String url, String token) {
        Log.e("tag", "URL-->" + url);
        ...
        try {
            ...
            httpPut.setHeader("x-api-key",token);
    ...
    public static String makeRequestTokenPut(String url, String token,String json) {
        Log.e("tag", "URL-->" + url);
        Log.e("tag", "input-->" + json);
    ...
    public static String makeRequestToken(String url, String token) {
        Log.e(TAG, "URL-->" + url);
        ...
        try {
            ...
            Log.e(TAG, "STATUS CODE-------------->"+status_code);
    ...
    public static int makeRequestAndReturnStatusCode(String url, String token,String json) {
        Log.e("tag", "URL-->" + url);
        Log.e("tag", "TOKEN-->" + token);
        Log.e("tag", "input-->" + json);

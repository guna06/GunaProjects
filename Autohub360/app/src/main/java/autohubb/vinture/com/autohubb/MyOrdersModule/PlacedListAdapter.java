...
public class PlacedListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
   ...
   /* public PlacedListAdapter(PriceQuotedPageActivity priceQuotedPageActivity, List<SingleItemListPojo> singleItemListPojos) {
    ...
    public PlacedListAdapter(PlacedPageActivity quotationPageActivity, List<SingleItemListPojo> singleItemListPojos) {

        this.activity=quotationPageActivity;
        this.singleItemListPojos=singleItemListPojos;
        inflater = LayoutInflater.from(activity);
    }

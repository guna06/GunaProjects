...
import com.sqindia.autolane360mobile.adapter.SoldCarAdapter;
...
public class SoldCarActivity extends Activity {
    RecyclerView recyclerView;
    CarList carList;
    SoldCarAdapter soldCarAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.soldcar);

        sharedlogin = PreferenceManager.getDefaultSharedPreferences(SoldCarActivity.this);
        editlogin = sharedlogin.edit();
        userid_str = sharedlogin.getString("org_user_id", "");
        token=sharedlogin.getString("token","");

        View v1 = getWindow().getDecorView().getRootView();
        FontsOverride.overrideFonts(SoldCarActivity.this, v1);
        ...
        if (Util.Operations.isOnline(SoldCarActivity.this)) {
    ...
    public class getCarList extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SoldCarActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                return jsonStr = HttpUtils.makeRequestToken(Config.GET_SOLD_CARS,token,json);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (status.equals("true")) {
                    ...
                    soldCarAdapter=new SoldCarAdapter(getApplicationContext(),carListList);
                    recyclerView.setAdapter(soldCarAdapter);
                    /*soldCarAdapter = new SoldCarAdapter(SoldCarActivity.class)
                    recyclerView.setAdapter(soldCarAdapter);*/

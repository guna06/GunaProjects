...
public class AddOperator extends Activity {
    Button addoperator_btn,viewoperator_btn;
    LinearLayout back,lnr_single,upload_lnr,lnr_select_file;
    String Str_operator,str_dept,str_empid,session_token,get_excel_file,path,msg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FontsOverride.overrideFonts(AddOperator.this, v1);
        ...
        //set default Loader:
        loader_dialog = new Dialog(AddOperator.this);
        ...
        upload_machine_excel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Animation RightSwipe = AnimationUtils.loadAnimation(AddOperator.this, R.anim.move_right);
        ...
        addoperator_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Util.Operations.isOnline(AddOperator.this)) {
                    if(!operator_id_edt.getText().toString().trim().equals(""))
                    {
                        if(!operator_name_edt.getText().toString().trim().equals(""))
                        {
                            if(!operator_dpt_edt.getText().toString().trim().equals("")){
                                new addOperatorAsync().execute();
                            }
                            else
                            {
                                Toast.makeText(getApplicationContext(),"Enter Employee Dept",Toast.LENGTH_LONG).show();
                            }
                        }
                        else
                        {
                            Toast.makeText(getApplicationContext(),"Enter Employee Name",Toast.LENGTH_LONG).show();
                        }
                ...
                {
                    new SweetAlertDialog(AddOperator.this, SweetAlertDialog.ERROR_TYPE)
                            .setTitleText("Oops...")
        ...
        viewoperator_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mac_view=new Intent(getApplicationContext(),ActivityNew.class);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (status.equals("true")) {
                    ...
                    Log.e("tag","Success");
                    new SweetAlertDialog(AddOperator.this, SweetAlertDialog.SUCCESS_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                    ...
                                    Intent i = new Intent(getApplicationContext(), AddOperator.class);
                                    startActivity(i);
                                }
                            })
                            .show();
                } else {
                    new SweetAlertDialog(AddOperator.this, SweetAlertDialog.WARNING_TYPE)

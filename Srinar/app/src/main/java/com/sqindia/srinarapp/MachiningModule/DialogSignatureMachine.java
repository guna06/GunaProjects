...
public class DialogSignatureMachine extends Dialog {

    Activity activity;
    TextView partname_tv;
    EditText qty_edt,edt_pincode;
    TextView approve_tv,l1;
    LinearLayout approve;
    Typeface segoeuil;
    String set_batchid, str_qty, token, set_qty,str_pincode,set_empid,complete_qty,approve_qty;
    Dialog loader_dialog;

    public DialogSignatureMachine(Activity act) {
        super(act);
        this.activity = act;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set_qty=sharedPreferences.getString("qc_partid","");
        set_batchid = sharedPreferences.getString("dia_mac_part_id", "");


        complete_qty=sharedPreferences.getString("dia_mac_complete_qty_mac","");
        approve_qty=sharedPreferences.getString("dia_mac_approved_qty_mac","");
            ...
            public void onClick(View v) {
                ...
                if (Util.Operations.isOnline(getContext())) {
                    if (!str_qty.equals("")) {
                        ...
                        int complete_val = Integer.parseInt(complete_qty);
                        int approve_val= Integer.parseInt(approve_qty);
                        int to_approve=complete_val-approve_val;

                        Log.e("tag","wonder To Approve------------------------------>"+to_approve);
                     ...
                     if (type_val > to_approve) {
                        ...
                        else
                        {
                            if(!str_pincode.equals(""))
                            {
                                ...
                                new machineQuantityApprovalAsync().execute();
                            }
                            else
                            {
    ...
    public class machineQuantityApprovalAsync extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                return jsonStr = HttpUtils.makeRequest1(Config.WEB_URL_MACHINE_APPROVAL,json,token);
                    ...
                    new SweetAlertDialog(getContext(), SweetAlertDialog.SUCCESS_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                    ...
                                    Intent i=new Intent(getContext(),QcMachineJob.class);

...
public class ElectroplateEntryActivity extends Activity{
    ...
    Typeface segoeui;
    String selected_part,selected_month,selected_year,selected_mc_approval,shift,emp_id,lineorder,str_sued,str_shift,str_machine,str_operator,str_part,str_subpart,session_token,str_ele_qty,str_remarks,str_dept,str_role,str_name,str_entrydate;

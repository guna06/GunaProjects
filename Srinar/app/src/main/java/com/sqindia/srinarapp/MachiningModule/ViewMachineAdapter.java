...
public class ViewMachineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;
    public LayoutInflater inflater;
    private List<MachineJobList> machineJobLists;
    SharedPreferences.Editor editor;
    String employeeid,get_batchid,get_quantity,session_token,str_dept,str_name,str_role,get_partid;
    Typeface lato;
    Dialog loader_dialog;


    public ViewMachineAdapter(ViewMachineJob viewMachineJob, List<MachineJobList> machineJobLists) {
        this.context=viewMachineJob;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(employeeid.equals(current.mac_wcentryby))
        {
      ...
      /* if(str_status.equals("0"))
       ...
       else if(str_status.equals(current.mac_quantitycompleted))
       {
    ...
    public class deleteMachineEntryAsync extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                return jsonStr = HttpUtils.makeRequest1(Config.WEB_URL_DELETE_MACHINE_WORK,json, session_token);
                    ...
                    new SweetAlertDialog(context, SweetAlertDialog.SUCCESS_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                    ...
                                    Intent job_mac=new Intent(context,ViewMachineJob.class);

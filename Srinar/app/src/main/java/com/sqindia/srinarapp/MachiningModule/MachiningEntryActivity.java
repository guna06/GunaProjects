...
public class MachiningEntryActivity extends Activity{
    ...
    Typeface segoeui;
    String selected_month,selected_year,selected_part,shift,str_empid,m_part,str_sued,str_shift,str_machine,str_operator,str_part,str_subpart,session_token,str_mac_qty,str_remarks,str_dept,str_name,str_role,machinename,str_entrydate;
